...
namespace Standartstyle.Controllers.Account
{
    public class CustomAuthentication : IAuthentication
    {
        ...
        public GeneralRepository Repository { get; set; }

        #region IAuthentication Members

        public UserModel Login(string userName, string Password, bool isPersistent)
        {
            UserModel retUser = Repository.UsersRepository.Login(userName, Password);
            if (retUser != null)
            {
